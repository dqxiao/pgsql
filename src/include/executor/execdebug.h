 ...
 * ----------------
 */
//#define EXEC_NESTLOOPDEBUG 1 // changed by dongqing
...
//#define EXEC_PROJECT 1
#ifdef EXEC_PROJECT
#define EP1_printf(message) printf("ExecProject:%s\n",message)
#endif
/* ----------------
...
//#define EXEC_EVALDEBUG 1 // changed by dongqing
...
extern int dq_ex_outer_tuplenum;
extern int current_count;
extern List *outer_tuples;
extern List * inner_annos;
extern bool full;
extern int agg_num;

extern int Multi_plan(PlanState * node);
