...
bool		Debug_print_parse = false; // first claim a variable
...
/*for propagation mode selection*/
//@dongqingxiao
char  *propagation_mode;
char * addannotation_lazy_mode;
char * delegated_mode;
...
static struct config_string ConfigureNamesString[] =
{
	...
	{
		{"propagation_mode", PGC_USERSET, LOGGING_WHAT,
						gettext_noop("set the propagation model"),
						NULL,
		},
		&propagation_mode,
		"",
	...
	{
			{"addannotation_lazy_mode", PGC_USERSET, LOGGING_WHAT,
							gettext_noop("set addannotation lazy mode"),
							NULL,
			},
			&addannotation_lazy_mode,
			"",
			NULL,NULL, NULL

		},
		{
					{"delegated_mode", PGC_USERSET, LOGGING_WHAT,
									gettext_noop("set delegated mode"),
									NULL,
					},
					&delegated_mode,
					"",
...
static struct config_enum ConfigureNamesEnum[] =
{
	...
	// @dongqingxiao,add an new opotion for propagation workingx
...
/*
 *  add new GUC variable to the list of known variables. The
